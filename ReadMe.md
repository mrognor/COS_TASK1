# Проверка ряда на ортонормальность
...
* $$\int_{a}^{b} F1(x)*F2(x) dx = 0$$
* $$\int_{a}^{b} F1(x)*F3(x) dx = 0$$
* $$\int_{a}^{b} F2(x)*F3(x) dx = 0$$
* $$\int_{a}^{b} F1(x)*F1(x) dx = 1$$
* $$\int_{a}^{b} F2(x)*F2(x) dx = 1$$
* $$\int_{a}^{b} F3(x)*F3(x) dx = 1$$  
...
|        |main.cpp|main.cpp 02|main.cpp O3 1000 точек на функцию|main.cpp O3 500 точек на функцию|main1.py|main2.py|index.js browser|index.js node.js|
|--------|--------|-----------|---------------------------------|--------------------------------|--------|--------|-----|-----|
